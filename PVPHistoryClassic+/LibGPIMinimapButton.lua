-- Modified version of LibGPIMinimapButton.lua
-- Original source obtained from https://github.com/Vysci/LFG-Bulletin-Board
...
function MinimapButton.Init(DB, Texture, DoOnClick, Tooltip)
    ...
    local button = CreateFrame("Button", "Lib_GPI_Minimap_" .. "BattleGoundHistory", Minimap)
